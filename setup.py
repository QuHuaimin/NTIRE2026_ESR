...
if __name__ == '__main__':
    ...
    setup(
        ...
        packages=find_packages(exclude=('options', 'datasets', 'experiments', 'results', 'wandb')),
        classifiers=[
        ...
        # Keep the challenge repository's large inference requirements intact.
        # This vendored BasicSR package only declares the focused training set.
        install_requires=get_requirements('requirements-training.txt'),
